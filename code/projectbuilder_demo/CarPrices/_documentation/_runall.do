*===============================================================
* _runall.do -- build website/index.html for CarPrices
*===============================================================
...
if _rc {
    ...
    * findfile too, so it takes a findable NAME, not a path.
    ...
    local here "/Users/ebooth/Documents/GitHub/Book Manuscript:Applied Evaluation-Stata/code/projectbuilder_demo/CarPrices/_documentation"
    cd "`here'"
